...
export type Member = {discord_id:string; name:string; role:Role; active:boolean};
export type Shift = {id:string; discord_id:string; started_at:string; ended_at:string|null};
export type Sale = {id:string; discord_id:string; customer:string; vehicle:string; plate:string; price:number; cost:number; commission:number; created_at:string; voided:boolean};
